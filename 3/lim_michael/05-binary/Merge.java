...
public class Merge{
	...
	public ArrayList<Comparable> msort3(ArrayList<Comparable> a){
		if (a.size() <= 1)
			return a;	

		ArrayList<Comparable> left = split2(a,1);
		ArrayList<Comparable> right = split2(a,2);
		left = msort2(left);
		right = msort2(right);
		return merge2(left, right);
	...
	public ArrayList<Comparable> merge3(ArrayList<Comparable> l, ArrayList<Comparable> r) {
	...
	public ArrayList<Comparable> split3(ArrayList<Comparable> a, int n){
		int size1 = a.size() / 2;
		int size2 = a.size()- size1;
		if (n==1){
